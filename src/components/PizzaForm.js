...
const PizzaForm = (props) => {
  return(
      <div className="form-row">
        <div className="col-5">
            <input onChange={props.handleChange} type="text" className="form-control" placeholder="Pizza Topping" 
        ...
        <div className="col">
          ...
          <div className="form-check">
            <input onChange={props.handleChange} className="form-check-input" type="radio" value="Not Vegetarian" checked={!props.editPizza.vegetarian}/>
            <label className="form-check-label">
              Not Vegetarian
            </label>
          </div>
